...
\chapter[title={\say{Phaedrus}}]

\inouter{Socrates meets Phaedrus; preliminary
conversation.}
\say{Socrates} My dear Phaedrus, where is it you're going, and {[}227a{]} 
...
\say{Phaedrus} Well then -- lead on. {[}c1{]}
...
\say{Socrates} How admirable of Lysias! I only wish he would {[}c10{]} write
...
\say{Phaedrus} Socrates, my good fellow, what do you mean? Do {[}228a{]} you
...
{[}a5{]} \say{Socrates} Phaedrus -- if I don't know Phaedrus, I've forgotten
...
\say{Phaedrus} So that's what I'll do. Nothing could be truer, {[}d1{]}
...
\say{Phaedrus} There's shade and a moderate breeze there, and {[}b1{]} grass
...
\say{Socrates} No, it was from a place two or three stades lower {[}c1{]}
down, where one crosses over to the district of
Agra; and there,
somewhere, there's an altar of Boreas.

\say{Phaedrus} I've not really noticed it. But do tell me, Socrates, {[}c5{]}
...
{[}b1{]} \say{Phaedrus} It's the very one.
...
\say{Socrates} Superhumanly, in fact, my friend; enough to make {[}d1{]} me
...
\say{Phaedrus} Don't do that, Socrates. Tell me really -- in the name {[}e1{]}
...
{[}e5{]} \say{Socrates} What? Should you and I also praise the speech on the
...
{[}b1{]} \say{Phaedrus} You're talking nonsense, Socrates; the very thing you
...
{[}c1{]} \say{Phaedrus} Who are these people? And where have you heard better
...
\say{Socrates} Have you been taking me seriously, Phaedrus, {[}b5{]} because I
...
\say{Phaedrus} Now here, my friend, you've really let me catch {[}c1{]} you.
...
{[}d10{]} \say{Phaedrus} No, I shall say it, and what I say will be an oath. I
...
\say{Socrates} You wretch, you! How well you've found the way {[}e5{]}to force
...
\say{Socrates} I shall speak with my head covered, so that I can {[}a5{]} rush
...
\say{Socrates} Then listen to me in silence. For the spot seems {[}d1{]}
...
{[}d5{]} \say{Socrates} For that you're to blame. But listen to what remains;
...
\say{Phaedrus} But I thought it was just in the middle, and would {[}d5{]} go
...
{[}e1{]} \say{Socrates} Haven't you noticed, my fine fellow, that I'm already
...
{[}d10{]} \say{Phaedrus} So it is said.

\say{Socrates} Not, I think, by Lysias, at any rate, nor by your {[}e1{]}
...
{[}c1{]} \say{Socrates} Yes, my good Phaedrus, for you see how shamelessly
...
\say{Phaedrus} I pray with you, Socrates: if indeed that is better {[}c1{]}
...
\say{Socrates} An absurd idea, young man; you much mistake your {[}d1{]}
...
\say{Phaedrus} He seemed to, Socrates; and I think you know {[}d5{]} yourself
...
\say{Socrates} You don't understand that at the beginning of a {[}258a{]}
politician's composition the commender's name is written first?

\say{Phaedrus} How so?

\say{Socrates} The writer says, I think, ‘It was resolved by the {[}a5{]}
...
{[}b10{]} \say{Socrates} Well then: when a person becomes a good enough
...
{[}c10{]} \say{Phaedrus} It's not very likely, from what you say; if he did,
it seems he would be reproaching what he himself desires.

{[}d1{]} \say{Socrates} This much, then, is clear to everyone, that writing
speeches is not {\em itself} something shameful.

\say{Phaedrus} How could it be?

\say{Socrates} But what is shameful, I think, is speaking and writing {[}d5{]}
...
\say{Phaedrus} You really ask if we need to? What would anyone {[}e1{]} live
...
\say{Socrates} A man who loves the Muses really ought to have {[}b5{]} heard
...
{[}e1{]} \say{Socrates} Then we should consider what we proposed just now:
...
\say{Phaedrus} What I have heard about this, my dear Socrates, is {[}260a{]}
...
{[}a5{]} \say{Socrates} Whatever wise people say, Phaedrus, is ‘a word not to
...
\say{Phaedrus} It would be ridiculous, Socrates. {[}b5{]}
...
\say{Phaedrus} So will she be right in saying this? {[}e1{]}
...
\say{Phaedrus} We need these arguments, Socrates; bring them {[}261a{]} here
...
\say{Phaedrus} Zeus! No, not quite that, I must say. A science of {[}b5{]}
...
{[}c1{]} \say{Phaedrus} Neither -- Zeus! -- have I heard of Nestor's, unless
you're dressing up Gorgias as a kind of Nestor, or maybe a Thrasymachus
or Theodorus as
Odysseus.

\say{Socrates}/ARGUMENTS Perhaps. But anyway let them pass. {[}c5{]} Now you
...
{[}c10{]} \say{Socrates}/ARGUMENTS So the man who does this scientifically
...
\say{Socrates}/ARGUMENTS Then the science of giving opposing {[}d10{]}
...
\say{Phaedrus} What sort of thing do you mean? {[}e5{]}
...
\say{Phaedrus} In those that differ little. {[}262a{]}
...
\say{Socrates}/ARGUMENTS In that case the person who means to {[}a5{]} deceive
...
\say{Socrates}/ARGUMENTS So is there any way in which a man {[}b5{]} will be a
...
{[}c1{]} \say{Socrates}/ARGUMENTS In that case, my friend, anyone who does not
...
{[}c5{]} \say{Socrates} ({\em returning to his own persona}) So do you want to
...
{[}c10{]} \say{Socrates} What's more, by some chance, it seems, the pair of
{[}d1{]} speeches as
...
{[}e1{]} \say{Phaedrus} ‘How it is with me, you know, and how I think it is to
...
{[}e5{]} \say{Socrates} Stop! We need to say, then, where the author goes
wrong and what he does unscientifically -- am I right?

{[}263a{]} \say{Phaedrus} Yes.
...
{[}a5{]} \say{Phaedrus} I think I understand what you mean, but tell me still
more clearly.
...
\say{Socrates} Then we are in accord in some cases, not in others. {[}b1{]}
...
\say{Phaedrus} Clearly in those cases where we go off in different {[}b5{]}
directions.
...
\say{Socrates} Admirably said; but tell me this too -- for of course {[}d1{]}
...
\say{Socrates} Dear me! How much more scientific you're saying {[}d5{]} the
...
{[}e5{]} \say{Socrates} Quote it, so I can hear it from the man himself.
...
\say{Socrates} He does indeed seem to be a long way from doing {[}a5{]} what
...
{[}b1{]} \say{Phaedrus} What he makes his speech about, Socrates, is certainly
an ending.
...
\say{Phaedrus} You're kind to think me competent to understand {[}c1{]} so
...
\say{Phaedrus} What's this epigram, and what feature of it are you {[}d1{]}
talking about?
...
\say{Phaedrus} What sort of thing do you mean? {[}265a{]}
...
\say{Socrates} I thought you were going to speak the truth, and {[}a5{]} say
...
{[}c5{]} \say{Socrates} Well then, let's take up this point from it: how the
...
\say{Socrates} What do you mean? Could there perhaps be something {[}d1{]}
...
{[}267a{]} \say{Socrates} Of course; and he tells us we must put in a
...
{[}b10{]} \say{Socrates} And how then are we to tell of the terms Polus
...
{[}c5{]} \say{Phaedrus} And weren't there some such things that belonged to
Protagoras?
...
\say{Phaedrus} You mean summarizing the points at the end, and {[}d5{]} so
...
\say{Socrates} You're right. But see, my fine friend, whether after {[}a5{]}
...
\say{Socrates} And what about if someone came up to Sophocles {[}c5{]} or
...
{[}269a{]} \say{Socrates} So Sophocles too would say that the man displaying
...
{[}a5{]} \say{Socrates} And what do we think, if the ‘honey-toned Adrastus',
...
\say{Socrates} I suppose it's no surprise, my good fellow, that {[}e1{]}
Pericles turned out to be the most complete of all with respect to
rhetoric.

\say{Phaedrus} Why do you say that?

\say{Socrates} All sciences of importance require the addition of {[}270a{]}
...
{[}b1{]} \say{Socrates} The method of the science of medicine is, I suppose,
the same as that of the science of rhetoric.

\say{Phaedrus} How is that?

\say{Socrates} In both sciences it is necessary to determine the {[}b5{]}
...
{[}b10{]} \say{Phaedrus} Probably it is like that, Socrates.

{[}c1{]} \say{Socrates} Do you think, then, that it's possible to understand
...
\say{Socrates} Well then, on the subject of nature, see what {[}c10{]}
...
\say{Socrates} And in the second place, he will show with which {[}a10{]} of
...
\say{Phaedrus} What way is this? {[}c5{]}
...
{[}c10{]} \say{Socrates} ‘Since the power of speech is in fact a leading of
...
{[}b5{]} \say{Phaedrus} It's impossible, I think, Socrates, to accept any
...
\say{Phaedrus} If it depended on trying, I would; but as things are, {[}c5{]}
...
\say{Phaedrus} Then you do just that. {[}d1{]}
...
\say{Socrates} At least I can tell you something I've heard, from {[}c1{]}
...
\say{Socrates} Well, what I heard was that one of the ancient gods {[}c5{]} of
...
{[}b5{]} \say{Socrates} Well, my friend, those in the sanctuary of Zeus of
...
\say{Socrates} So the man who thinks that he has left behind him {[}c5{]} a
...
\say{Socrates} The kind of speech that is written together with {[}a5{]}
...
{[}b1{]} \say{Socrates} Absolutely. So tell me this: the sensible farmer who
...
{[}c1{]} \say{Phaedrus} Just so, I think, Socrates: he would do the one sort
...
{[}c10{]} \say{Phaedrus} It certainly isn't likely.

{[}d1{]} \say{Socrates} No, it isn't; but his gardens of letters, it seems, he
...
{[}e1{]} \say{Phaedrus} It's a quite beautiful form of amusement you're
...
\say{Phaedrus} This is indeed much finer still. {[}a5{]}
...
\say{Socrates} Until a person knows the truth about each of the {[}b5{]}
...
\say{Socrates} And what about the matter of its being fine or {[}d1{]}
...
{[}e5{]} \say{Socrates} But the person who thinks that there is necessarily
...
{[}b5{]} \say{Phaedrus} Yes, absolutely. I wish and pray for what you say.
...
\say{Phaedrus} And what of you? What will you do? For we certainly {[}e5{]}
...
{[}b5{]} \say{Phaedrus} I'll do it. But let's go, now that the heat has become
milder.
