...
\inouter{Transition to Socrates' first speech.}
...
\inouter{Socrates' first speech on erôs}
...
\inouter{Transition to Socrates' second speech.}
...
\inouter{Socrates' second speech begins.}
...
\inouter{‘Experiences and actions' of divine and human souls.}
...
\inouter{The blessings of the madness of erôs}
...
\inouter{Transition to a discussion of speaking and writing.}
...
\inouter{Rhetoric -- as it should be, and as it is.}
...
\say{Socrates}({\em Arguments}) Well then, will not the science of rhetoric as a
...
\say{Socrates}({\em Arguments}) What? Have you only heard of the manuals on rhetoric
...
\say{Socrates}({\em Arguments}) Perhaps. But anyway let them pass.  Now you
...
\say{Socrates}({\em Arguments}) About the just and unjust?

\say{Phaedrus}Yes.

 \say{Socrates}{(\em Arguments)} So the man who does this scientifically
 will make the same thing appear to the same people at one time
just and, whenever he wishes, unjust?

\say{Phaedrus}Of course.

\say{Socrates}({\em Arguments}) And in public addresses he will make the same things
seem to the city at one time good, at another the
opposite?

 \say{Phaedrus}Just so.

\say{Socrates}({\em Arguments}) Well, don't we recognize the Eleatic Palamedes as
...
\say{Socrates}({\em Arguments}) Then the science of giving opposing 
...
\say{Socrates}({\em Arguments}) I think it will become clear if we direct our search
...
\say{Socrates}({\em Arguments}) At any rate, when you are passing over from one thing
...
\say{Socrates}({\em Arguments}) In that case the person who means to  deceive
...
\say{Socrates}({\em Arguments})S So will he be able, if he is ignorant of the truth of
...
\say{Socrates}({\em Arguments}) Then clearly those who hold beliefs contrary to what
...
\say{Socrates}({\em Arguments}) So is there any way in which a man  will be a
...
\say{Phaedrus}No, never.
 ...
 \say{Socrates}({\em Arguments}) In that case, my friend, anyone who does not
...
\inouter{How useful is the written text (or the set speech) as a medium of 
...
\say{Phaedrus}What are the titles you assign him, then? 

\say{Socrates}To call him wise seems to me to be too much, and to be 
fitting only in the case of a god; to call him either a
philosopher or something like that would both fit him more  and be in better taste.
...
\inouter{A final prayer, after which Socrates and Phaedrus leave.}
